...
private _trainDistanceFromStart = _train getVariable ["ATRAIN_Distance_From_Front",0];
...
_train setVariable ["ATRAIN_Node_Path",_nodePath, true];
_train setVariable ["ATRAIN_Node_Path_Distance",_trainNodePathDistance, true];
_train setVariable ["ATRAIN_Distance_From_Front",_trainDistanceFromStart, true];
